...
<head>
    ...
    <title>Forgot Password | TaskFlow Enterprise</title>
...
<body>
    ...
    <div class="auth-card">
        ...
        <p class="auth-subtitle">Enter your registered email address and we will dispatch a secure password reset link to your inbox.</p>

        <div class="info-box">
            <span style="font-size: 1.1rem; line-height: 1;">✉️</span>
            <div>
                <strong>Email Verification:</strong> For security, a time-limited reset link will be sent to your inbox. You can securely change your password after clicking the verification link.
            </div>
        </div>
        ...
        <form action="{{ route('password.email') }}" method="POST" id="forgot-password-form">
            ...
            <button type="submit" class="btn-submit">Send Reset Verification Link</button>
        </form>
