...
<head>
    ...
    <title>Reset Password | TaskFlow Enterprise</title>
...
<body>
    ...
    <div class="auth-card">
        ...
        <p class="auth-subtitle">Choose a new, strong password to change your password and regain access to your account.</p>

        <div class="info-box">
            <span style="font-size: 1.1rem; line-height: 1;">🔒</span>
            <div>
                <strong>Email Verification Verified:</strong> Your reset token is authenticated. Once updated, you can immediately sign in with your new credentials.
            </div>
        </div>
        ...
        <form action="{{ route('password.update') }}" method="POST" id="reset-form">
            ...
            <div class="form-group">
                ...
                <input type="email" id="email" name="email" class="form-control" value="{{ old('email', $email) }}" required autocomplete="email" placeholder="name@company.com">
            </div>
            ...
            <div class="form-group">
                ...
                <div class="input-password-wrap">
                    ...
                    <button type="button" class="btn-eye-toggle" onclick="togglePassword('password_confirmation', this)" aria-label="Toggle password visibility" title="Show/Hide Password">
                        <!-- Eye Open -->
                        <svg class="eye-open" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                            <circle cx="12" cy="12" r="3"></circle>
            ...
            <div class="password-rules-box">
                <div class="strength-header">
                    ...
                    <span id="strength-badge" class="strength-badge">Too Weak</span>
                </div>
            ...
            <button type="submit" class="btn-submit" id="submit-btn">Reset & Change Password</button>
        </form>

        <div class="auth-footer">
            Remembered your credentials? <a href="{{ route('login') }}">Back to Sign In</a>
        </div>
    </div>
    ...
    <script>
        ...
        function evaluatePassword() {
            ...
            setRuleState(rules.length, isLength);
            setRuleState(rules.upper, isUpper);
            setRuleState(rules.lower, isLower);
            setRuleState(rules.number, isNumber);
            setRuleState(rules.symbol, isSymbol);
            setRuleState(rules.match, isMatch);
